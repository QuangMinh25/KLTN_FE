        ...
        <>
            ...
            <div className="container et-main-content" ng-show="!bannerTet">
                ...
                <div data-ng-view className="shuffle-animation ng-scope" style={{ paddingRight: '0px', paddingLeft: '0px' }}>
                    <div className="col-md-12 ng-scope">
                        <div className="row et-page-header">
                            <span className="et-main-label">
                                <strong className="ng-binding">Hướng dẫn{/*Hướng dẫn*/}</strong>
                            </span>
                        </div>
                        <div ng-bind-html="'PGuide_item1_huongDanMuaVe'|translate" className="ng-binding">
                            1. Hướng dẫn thực hiện các quy định về việc mua vé và thanh toán trực tuyến trên website dsvn.vn, chi tiết xem <a href="/#/pages/huongdanmuave">tại đây</a>.
                        </div>
                        <div ng-bind-html="'PGuide_item2_videoHuongDan'|translate" className="ng-binding">2. Các video hướng dẫn</div>
                        <div className="col-md-12 form-group">
                            <div>
                                a. <a href="https://youtu.be/NQI8L7q9yUY" target="_blank" className="ng-binding"> Hướng dẫn mua vé và thanh toán trực tuyến{/*Hướng dẫn mua vé và thanh toán trực tuyến*/} </a>
                            </div>
                            <div>
                                b. <a href="https://youtu.be/akATHqdUj0Y" target="_blank" className="ng-binding"> Hướng dẫn mua vé và thanh toán trả sau{/*Hướng dẫn mua vé và thanh toán trả sau*/} </a>
                            </div>
                            <div>
                                c. <a href="https://youtu.be/DhUUxA3ZkO0" target="_blank" className="ng-binding"> Hướng dẫn đăng kí hàng đợi{/*Hướng dẫn đăng kí hàng đợi*/} </a>
                            </div>
                            <div>
                                b. <a href="https://youtu.be/ZPL8oM5i4Fg" target="_blank" className="ng-binding"> Hướng dẫn về quy trình trả vé{/*Hướng dẫn về quy trình trả vé*/} </a>
                            </div>
                        </div>
                    </div>
                </div>
