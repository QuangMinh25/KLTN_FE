...
export default function QuyDinhMuaVe() {
    return (
        <>
                ...
                <div className="container et-main-content" ng-show="!bannerTet">
                    ...
                    <div data-ng-view className="shuffle-animation ng-scope" style={{ paddingRight: '0px', paddingLeft: '0px' }}>
                        <div className="et-col-md-12 ng-scope">
                            <div>
                                <div className="row et-page-header">
                                    <span className="et-main-label">
                                        <strong className="ng-binding">CÁC QUY ĐỊNH{/*Các quy định*/}</strong>
                                    </span>
                                </div>
                                <div>
                                    <div className="list-group">
                                        <div className="list-group-item">
                                            <span className="badge" style={{ float: 'left' }}>1</span> &nbsp;
                                            <a href="/#/pages/dieukienvadieukhoan" className="ng-binding">Các Điều Kiện &amp; Điều Khoản{/*Các Điều Kiện & Điều Khoản*/}</a>
                                        </div>
                                        <div className="list-group-item">&nbsp; &nbsp; <a href="/#/pages/quydinhvanchuyen">1.1. Quy định vận chuyển</a></div>
                                        <div className="list-group-item">&nbsp; &nbsp; <a href="/#/pages/dieukiensudunghethong">1.2. Điều kiện sử dụng hệ thống mua vé trực tuyến</a></div>
                                        <div className="list-group-item">&nbsp; &nbsp; <a href="/#/pages/dienkiensudungwebsite">1.3 Điều khoản sử dụng website dsvn.vn</a></div>
                                        <div className="list-group-item">
                                            <span className="badge" style={{ float: 'left' }}>2</span> &nbsp;
                                            <a href="/#/pages/phuongthucthanhtoan" className="ng-binding">Phương thức thanh toán{/*Phương thức Thanh toán*/}</a>
                                        </div>
                                        <div className="list-group-item">
                                            <span className="badge" style={{ float: 'left' }}>3</span> &nbsp;
                                            <a href="/#/pages/chinhsachhoantra" className="ng-binding">Chính sách hoàn trả vé{/*Chính sách hoàn trả vé*/}</a>
                                        </div>
                                        {/*<div class="list-group-item">
                    &nbsp; &nbsp; <a href="/#/pages/dieukienvadieukhoan">3.1. Quy định hoàn trả vé</a>
                </div>
                <div class="list-group-item">
                    &nbsp; &nbsp; <a href="/#/pages/dieukienvadieukhoan">3.2. Các bước thực hiện trả vé</a>
                </div>
                <div class="list-group-item">
                    &nbsp; &nbsp; <a href="/#/pages/dieukienvadieukhoan">3.3. Quy trình hoàn tiền về tài khoản</a>
                </div>*/}
                                        <div className="list-group-item">
                                            <span className="badge" style={{ float: 'left' }}>4</span> &nbsp;
                                            <a href="/#/pages/chinhsachbaomat" className="ng-binding">Chính sách Bảo Mật Thông Tin{/*Chính sách Bảo Mật Thông Tin*/}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
