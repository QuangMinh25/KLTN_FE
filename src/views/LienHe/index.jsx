            ...
            <div className="container et-main-content" ng-show="!bannerTet">
                ...
                <div data-ng-view className="shuffle-animation ng-scope" style={{ paddingRight: '0px', paddingLeft: '0px' }}>
                    <div className="et-col-md-12 ng-scope">
                        <div>
                            <h3 className="ng-binding">{/*Thông tin liên hệ*/}Thông tin liên hệ</h3>
                            <div className="row">
                                <div className="col-xs-12 col-sm-6 et-col-md-6">
                                    <h5 style={{ color: '#e55a05', fontWeight: 'bold' }} className="ng-binding">{/*Tổng công ty Đường  sắt Việt Nam*/}Tổng công ty Đường sắt Việt Nam</h5>
                                    <br />
                                    <p className="ng-binding">{/*Số 118 Lê Duẩn, Hoàn Kiếm, Hà Nội.*/}Số 118 Lê Duẩn, Hoàn Kiếm, Hà Nội.</p>
                                    <p className="ng-binding">
                                        {/*Điện thoại: 19006469*/}{/*{{'PContact_phone'|translate}}<br />*/}
                                        {/*Email: dsvn@vr.com.vn.*/}Email: dsvn@vr.com.vn.<br />
                                    </p>
                                    <p style={{ fontSize: '11px' }} className="ng-binding">
                    ...
                    <br /><br /> Mã số doanh nghiệp: 0100105052, đăng ký lần đầu ngày 26/07/2010, đăng ký thay đổi lần 4 ngày 27/06/2014 tại Sở KHĐT Thành phố Hà Nội.*/}
                                ...
                                <div className="col-xs-12 col-sm-6 et-col-md-6">
                                    <h5 style={{ color: '#e55a05', fontWeight: 'bold' }} className="ng-binding">{/*Tổng đài hỗ trợ khách hàng*/}Tổng đài hỗ trợ khách hàng</h5>
                                    {/*<p>{{'PContact_phone1'|translate}}</p>*/}
                                    <p className="ng-binding">{/*Khu vực miền Bắc: <label>1900 0109</label>*/}Khu vực miền Bắc: 1900 0109</p>
                                    <p className="ng-binding">{/*Khu vực miền Nam: <label>1900 1520</label>*/}Khu vực miền Nam: 1900 1520</p>
                                    <p>
                                        Email: support1@dsvn.vn<br />
                                        <span style={{ visibility: 'hidden' }}>Email: </span>support2@dsvn.vn
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div className="et-col-md-3" />
                    </div>
                </div>
